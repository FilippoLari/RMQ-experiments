...
class HBRMQWrapper : public HBRMQ<K, Range, Pos, Floating, Threshold, Epsilon> {

public:
    
    HBRMQWrapper(std::vector<K> data) : HBRMQ<K, Range, Pos, Floating, Threshold, Epsilon>(data) {}
