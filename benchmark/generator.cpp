...
int main(int argc, char* argv[]) {
    ...
    std::vector<int64_t> pseudo_inc = generate_pseudo_increasing(n, 0);

    write_data<int64_t>(pseudo_inc, "pseudo_inc_1B_0.bin");
    ...
    write_data<query_type>(queries, "queries_pseudo_inc_1B_0.bin");
